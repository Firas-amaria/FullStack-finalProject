...
router.post("/send", authenticateUser, async (req, res) => {
  try {
    ...
    // **Check if the user is asking about a medical condition**
      ...
      userMessage.includes("כאב ראש") ||
      userMessage.includes("חום גבוה")
    ) {
...
const getMedicalAdvice = async (symptoms) => {
  const medicalResponses = {
    "כאב ראש":
      "אם יש לך כאב ראש קל, נסה לשתות מים ולנוח. אם הכאב נמשך, מומלץ להיוועץ ברופא.",
    "חום גבוה":
      "אם החום עולה מעל 38.5°C למשך יותר מיום, מומלץ לקחת אקמול ולפנות לרופא.",
    "לחץ דם גבוה":
      "במצב של לחץ דם גבוה, מומלץ לבדוק את לחץ הדם ולהימנע ממלח. יש לפנות לרופא להמשך בירור.",
  };
